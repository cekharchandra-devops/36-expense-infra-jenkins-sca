after eks cluster creation, create one more job for configure cluster like rds db user creation, 

namespace creation,aws load balancer controller creation
